...
def test_get_phone_number():
    assert get_phone_number(["25/04/2025", "9:00", "John Doe", "1234567890"]) == "1234567890"
    assert get_phone_number(["25/04/2025", "9:00", "John Doe", "123456 7890"]) == "1234567890"
    assert not get_phone_number(["25/04/2025", "9:00", "John Doe", "1234567890"]) == "3333333333"
